    ...
    <div 
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-8">Join thousands of gamers in our community</p>
          <button
            onClick={() => navigate('/auth/signup')}
            className="glass-button bg-gradient-to-r from-purple-600 to-pink-600 px-10 py-4 text-lg font-bold"
          >
            Get Started Now
          </button>
        </div>
